...
def weightedLoss(originalLossFunc, weightsList):
    def lossFunc(true, pred):
        ...
        classSelectors = [K.equal(K.cast(i, "int64"),
                                  K.cast(classSelectors, "int64")
        ...
        weights = [sel * w for sel,w in zip(classSelectors, sorted(value for value in weightsList.values()))] 
